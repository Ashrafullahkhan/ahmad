...
import { CategoryForm } from '../../sections/@dashboard/calendar';
// ----------------------------------------------------------------------
...
const TABLE_HEAD = [
  { id: 'name', label: 'Image', alignRight: false },
  { id: 'createdAt', label: 'Name', alignRight: false },
  { id: 'inventoryType', label: 'Is Meal', alignRight: false },
  { id: '' },
];
    ...
    <Page title="Ecommerce: Product List">
      <Container maxWidth={themeStretch ? false : 'lg'}>
        ...
        <DialogAnimate open={isOpenModal} onClose={handleCloseModal}>
          <DialogTitle>{selectedEvent ? 'Edit Category' : 'Add Category'}</DialogTitle>

          <CategoryForm event={selectedEvent || {}} range={selectedRange} onCancel={handleCloseModal} />
        </DialogAnimate>
        <Card>
          <ProductListToolbar
              ...
              <Table>
                ...
                <TableBody>
                  {filteredProducts.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => {
                    const { id, name, cover, createdAt, inventoryType } = row;
